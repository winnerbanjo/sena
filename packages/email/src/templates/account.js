...
function renderVerifyEmail(params) {
    ...
    ${(0, elements_1.renderParagraph)('Please click the button below to confirm that this email belongs to you. This verification link expires in <strong>' +
        expiresIn +
        ' minutes</strong>.')}
    ${(0, elements_1.renderButton)('Verify Email Address', params.verificationUrl)}
    ${(0, elements_1.renderParagraph)('If you did not create a Sena account, you can safely ignore this message.', true)}

 ...
 */
export function renderSenaEmailLayout(contentHtml: string, options: EmailLayoutOptions): string {
  const {
    title,
    previewText = '',
    headerType = 'platform',
 ...
 */
export function renderSenaEmailHeader(): string {
  return `
    <tr>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          <tr>
            <td valign="middle" align="left">
              <a href="${SENA_BRAND.websiteUrl}" target="_blank" style="text-decoration: none; display: inline-block;">
                <img src="${SENA_BRAND.logoUrl}" alt="Sena" width="96" style="display: block; width: 96px; max-width: 96px; height: auto;" border="0" />
              </a>
            </td>
 ...
 */
export function renderSenaPropertyHeader(params: {
  propertyName: string;
  propertyLogoUrl?: string;
  propertyAddress?: string;
  propertyPhone?: string;
 ...
 */
export function renderSenaEmailFooter(options: { showSupportLink?: boolean; unsubscribeUrl?: string }): string {
          ...
          <tr>
            <td align="left" style="font-size: 12px; color: #8C8275; line-height: 1.6;">
              ...
              <div style="margin-top: 12px; font-size: 11px;">
                <a href="${SENA_BRAND.websiteUrl}" style="color: #71382D; text-decoration: none; font-weight: 500;">sena.ng</a> &nbsp;·&nbsp;
                <a href="${SENA_BRAND.appUrl}" style="color: #71382D; text-decoration: none; font-weight: 500;">Console</a> &nbsp;·&nbsp;
                <a href="${SENA_BRAND.websiteUrl}/privacy" style="color: #71382D; text-decoration: none; font-weight: 500;">Privacy</a> &nbsp;·&nbsp;
                <a href="${SENA_BRAND.websiteUrl}/terms" style="color: #71382D; text-decoration: none; font-weight: 500;">Terms</a>
                ${
                  showSupportLink
                    ? `&nbsp;·&nbsp; <a href="mailto:${SENA_BRAND.supportEmail}" style="color: #71382D; text-decoration: none; font-weight: 500;">Support</a>`
                    : ''
                }
                ${
                  unsubscribeUrl
 ...
 */
export function renderSenaPropertyFooter(params: {
  propertyName: string;
  propertyAddress?: string;
  propertyPhone?: string;
  propertyEmail?: string;
          ...
          <tr>
            <td align="left" style="font-size: 12px; color: #8C8275; line-height: 1.6;">
              ...
              <div style="margin-top: 14px; font-size: 11px; color: #A69E92; border-top: 1px solid #EAE3D9; padding-top: 10px;">
                Powered by <a href="${SENA_BRAND.websiteUrl}" style="color: #71382D; font-weight: 600; text-decoration: none;">Sena</a> · hospitality, simplified.
              </div>
            </td>
          </tr>
        </table>
 ...
 */
export function renderSenaEditorialFooter(options: { unsubscribeUrl?: string }): string {

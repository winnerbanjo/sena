        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link href={`/${slug}/rooms`} className="hover:text-white transition-colors">
                  Rooms &amp; Suites
                </Link>
              </li>
              <li>
                <Link href={`/${slug}/gallery`} className="hover:text-white transition-colors">
                  Photo Gallery
                </Link>
              </li>
              <li>
                <Link href={`/${slug}/reviews`} className="hover:text-white transition-colors">
                  Guest Reviews
                </Link>
              </li>
              <li>
                <Link href={`/${slug}/about`} className="hover:text-white transition-colors">
                  Our Story
                </Link>
              </li>
              <li>
                <Link href={`/${slug}/contact`} className="hover:text-white transition-colors">
                  Contact &amp; Location
                </Link>
              </li>
            </ul>

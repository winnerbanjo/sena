...
export function CommandPalette({ open, onClose, onOpenNewReservation }: CommandPaletteProps) {
  ...
  const pages: CommandItem[] = [
    ...
    { id: 'p-rooms', category: 'pages', title: 'Room Inventory', subtitle: 'Status of all 26 rooms and suites', icon: Layers, action: () => router.push('/rooms') },
    ...
    { id: 'p-offers', category: 'pages', title: 'Offers & Promotions', subtitle: 'Promo codes, seasonal discounts and staycation specials', icon: Tag, action: () => router.push('/offers') },
    { id: 'p-channels', category: 'pages', title: 'Channels & OTAs', subtitle: 'Booking.com, Airbnb, Expedia channel integrations', icon: Layers, action: () => router.push('/channels') },
    { id: 'p-analytics', category: 'pages', title: 'Analytics & Insights', subtitle: 'RevPAR, ADR, occupancy rates and channel mix', icon: TrendingUp, action: () => router.push('/analytics') },

...
export function Topbar({ title, onOpenNewReservation, onOpenSearch }: TopbarProps) {
  ...
  return (
    <header className="h-16 border-b border-[#E8E2DA] bg-white px-8 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded border border-[#E8E2DA] bg-white text-xs text-[#7A7267] hover:border-[#B85C3E]/50 transition-colors w-48 justify-between"
        >
        ...
        {/* Notifications */}
        <button className="w-9 h-9 rounded border border-[#E8E2DA] bg-white flex items-center justify-center text-[#191816] hover:bg-[#F9F9F9] transition-colors relative">
